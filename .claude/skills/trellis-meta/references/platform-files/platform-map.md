...
| ZCode | `--zcode` | `.zcode/` | `.zcode/skills/` | `.zcode/agents/` | `.zcode/hooks/` delegates invoked by required external `trellis-bridge` 0.2.0+ plugin; current ZCode ignores project `.zcode/config.json` hooks |
