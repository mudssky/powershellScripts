...
macOS、Linux/WSL 与 Windows 的真实叶子均已接入。Windows 11 22H2+ x64 和 Windows 10 22H2 x64 支持 Core/Full；Windows ARM64 和 Server 返回明确 Partial/Blocked。Linux 完整支持 Ubuntu/Debian、Arch、WSL 客体与 amd64，ARM 返回明确 Blocked。声明支持但入口缺失时不会回退旧脚本伪报完整成功。
